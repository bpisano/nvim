      ...
      textobjects = {
        ...
        move = {
          ...
          goto_next_end = {
            ...
            ["]F"] = { query = "@call.inner", desc = "Next function call end" },
            ["]M"] = { query = "@function.inner", desc = "Next method/function def end" },
          ...
          goto_previous_start = {
            ...
            ["[f"] = { query = "@call.inner", desc = "Prev function call start" },
            ["[m"] = { query = "@function.inner", desc = "Prev method/function def start" },
          ...
          goto_previous_end = {
            ...
            ["[F"] = { query = "@call.inner", desc = "Prev function call end" },
            ["[M"] = { query = "@function.inner", desc = "Prev method/function def end" },
            ["[C"] = { query = "@class.inner", desc = "Prev class end" },
